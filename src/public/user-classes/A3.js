    ...
    return class A3 extends Manager {
        ...
        creatingAccountButtonClickEvent() {
            ...
            function fillTableOfUser() {
                ...
                return arrayOfWardUser;
            }
            let arrayOfWardUser = fillTableOfUser();


            $('input.name-quyen-input.same-left-input').on('change', () => {
                if (arrayOfWardUser[$('input.name-quyen-input.same-left-input').val()] == true) {
                    $('button.permission-foot-block-btn').show();
                    $('button.permission-foot-yes-btn.same-foot-yes-btn').hide();
                } else if (arrayOfWardUser[$('input.name-quyen-input.same-left-input').val()] == false) {
                    $('button.permission-foot-block-btn').hide();
                    $('button.permission-foot-yes-btn.same-foot-yes-btn').show();
                } else {
                    console.log(arrayOfWardUser[$('input.name-quyen-input.same-left-input').val()]);
                    $('button.permission-foot-block-btn').hide();
                    $('button.permission-foot-yes-btn.same-foot-yes-btn').hide();
                }
            });
                ...
                axios({ // change declare date
                    ...
                    if (res.data.success) {
                        axios({ // change declare permission of an user to true
                            ...
                            if (res.data.success) {
                                arrayOfWardUser = fillTableOfUser();
                                $('button.permission-foot-block-btn').show();
                                $('button.permission-foot-yes-btn.same-foot-yes-btn').show();
